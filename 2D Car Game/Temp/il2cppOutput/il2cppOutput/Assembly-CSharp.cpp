...
public:
	...
	inline static int32_t get_offset_of_scoreValue_16() { return static_cast<int32_t>(offsetof(Enemy_tF0E5C8811BC93A523814C562C545DB3C1A755627, ___scoreValue_16)); }
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Enemy_Die_m9FD6BE305AA5A3AA47F4BA3E3D0DBFC39E4F7CFE (Enemy_tF0E5C8811BC93A523814C562C545DB3C1A755627 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_12);
		GameSession_AddToScore_m25B41713BA1B9089BD1E3E644D71951C6DBBEE14(L_12, L_13, /*hidden argument*/NULL);
		// }
		return;
	}
}
...
{
	{
		...
		__this->set_scoreValue_16(((int32_t)50));
		MonoBehaviour__ctor_mC0995D847F6A95B1A553652636C38A2AA8B13BED(__this, /*hidden argument*/NULL);
		return;
	}
}
...
IL_00a0:
	{
		...
		int32_t L_27 = __this->get_scoreValue_6();
		NullCheck(L_26);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Player_Die_m16A200929DBDF9FF88C8191A26327C2CCCC80C19 (Player_t5689617909B48F7640EA0892D85C92C13CC22C6F * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		AudioClip_t16D2E573E7CC1C5118D8EE0F0692D46866A1C0EE * L_6 = __this->get_playerDeathSound_9();
		Camera_tC44E094BAB53AFC8A014C6F9CFCE11F4FC38006C * L_7 = Camera_get_main_mC337C621B91591CEF89504C97EF64D717C12871C(/*hidden argument*/NULL);
		NullCheck(L_7);
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_8 = Component_get_transform_mE8496EBC45BEB1BADB5F314960F1DF1C952FA11F(L_7, /*hidden argument*/NULL);
		NullCheck(L_8);
		Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  L_9 = Transform_get_position_m40A8A9895568D56FFC687B57F30E8D53CB5EA341(L_8, /*hidden argument*/NULL);
		float L_10 = __this->get_playerDeathSoundVolume_10();
		AudioSource_PlayClipAtPoint_m1DB4B29B9FBCF0832AB7855AD2B2B319322B61FC(L_6, L_9, L_10, /*hidden argument*/NULL);
		// Destroy(explosion, explosionDuration);
...
{
	{
		...
		__this->set_playerDeathSoundVolume_10((0.75f));
		MonoBehaviour__ctor_mC0995D847F6A95B1A553652636C38A2AA8B13BED(__this, /*hidden argument*/NULL);
		return;
	}
}
